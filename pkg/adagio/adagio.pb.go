...
type Node_Spec struct {
	...
	Retry                []*Node_Spec_Retry        `protobuf:"bytes,4,rep,name=retry,proto3" json:"retry,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *Node_Spec) GetRetry() []*Node_Spec_Retry {
	if m != nil {
		return m.Retry
	}
	return nil
...
func (m *Node_Spec_Retry) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
var fileDescriptor_5eb97351c0f66fbe = []byte{
	...
	,
}
